...
public class EngineMinMaxNoMateDection implements Engine {
...
//	public static int MAX_DEPTH = 5;
	public static int MAX_TOTAL_NODE = 255;
	public static int MAX_NODE = 64;
	...
	public EngineMinMaxNoMateDection(int team){
		this.team = team;
